...
pub fn item_sprite(name: &str) -> SpriteRef {
    match name {
        ...
        // Food — meats (CoinPurse as generic meat icon)
        "Rat Meat"       => ItemSprite::CoinPurse.sprite_ref(),
        "Wolf Meat"      => ItemSprite::CoinPurse.sprite_ref(),
        "Boar Meat"      => ItemSprite::CoinPurse.sprite_ref(),
        "Bear Meat"      => ItemSprite::CoinPurse.sprite_ref(),
        "Fox Meat"       => ItemSprite::CoinPurse.sprite_ref(),
        "Cougar Meat"    => ItemSprite::CoinPurse.sprite_ref(),
        "Snake Meat"     => ItemSprite::CoinPurse.sprite_ref(),
        "Gator Meat"     => ItemSprite::CoinPurse.sprite_ref(),
        "Lion Meat"      => ItemSprite::CoinPurse.sprite_ref(),
        "Fowl Meat"      => ItemSprite::CoinPurse.sprite_ref(),
        "Badger Meat"    => ItemSprite::CoinPurse.sprite_ref(),
        "Jackal Meat"    => ItemSprite::CoinPurse.sprite_ref(),
        "Ocelot Meat"    => ItemSprite::CoinPurse.sprite_ref(),
        "Coyote Meat"    => ItemSprite::CoinPurse.sprite_ref(),
        "Hyena Meat"     => ItemSprite::CoinPurse.sprite_ref(),
        "Lynx Meat"      => ItemSprite::CoinPurse.sprite_ref(),
        "Lizard Meat"    => ItemSprite::CoinPurse.sprite_ref(),
        "Yak Meat"       => ItemSprite::CoinPurse.sprite_ref(),
        "Buffalo Meat"   => ItemSprite::CoinPurse.sprite_ref(),
