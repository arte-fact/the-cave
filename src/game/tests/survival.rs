...
use super::{test_game, health_potion};
    ...
    fn equip_ring() {
        ...
        g.inventory.push(Item {
            kind: ItemKind::Ring, name: "Gold Ring", glyph: '=', effect: ItemEffect::BuffAttack(4), weight: 0, durability: 30,
        });
    ...
    fn ring_boosts_defense() {
        ...
        g.equipped_ring = Some(Item {
            kind: ItemKind::Ring, name: "Diamond Ring", glyph: '=', effect: ItemEffect::BuffDefense(4), weight: 0, durability: 30,
        });
    ...
    fn ring_swaps_to_inventory() {
        ...
        let mut g = Game::new(map);
        g.equipped_ring = Some(Item {
            kind: ItemKind::Ring, name: "Copper Ring", glyph: '=', effect: ItemEffect::BuffAttack(1), weight: 0, durability: 30,
        });
        g.inventory.push(Item {
            kind: ItemKind::Ring, name: "Gold Ring", glyph: '=', effect: ItemEffect::BuffAttack(4), weight: 0, durability: 30,
        });
    ...
    fn equip_helmet() {
        ...
        let mut g = Game::new(map);
        g.inventory.push(Item {
            kind: ItemKind::Helmet, name: "Leather Cap", glyph: '^', effect: ItemEffect::BuffDefense(1), weight: 0, durability: 25,
        });
        assert!(g.equip_item(0));
        assert!(g.inventory.is_empty());
    ...
    fn equip_shield() {
        ...
        let mut g = Game::new(map);
        g.inventory.push(Item {
            kind: ItemKind::Shield, name: "Wooden Shield", glyph: ')', effect: ItemEffect::BuffDefense(1), weight: 0, durability: 25,
        });
        assert!(g.equip_item(0));
        assert!(g.inventory.is_empty());
    ...
    fn equip_boots() {
        ...
        let mut g = Game::new(map);
        g.inventory.push(Item {
            kind: ItemKind::Boots, name: "Leather Boots", glyph: '{', effect: ItemEffect::BuffDefense(1), weight: 0, durability: 25,
        });
        assert!(g.equip_item(0));
        assert!(g.inventory.is_empty());
    ...
    fn helmet_swaps_to_inventory() {
        ...
        g.inventory.push(Item {
            kind: ItemKind::Helmet, name: "Iron Helmet", glyph: '^', effect: ItemEffect::BuffDefense(3), weight: 0, durability: 40,
        });
        g.equip_item(0);
    ...
    fn shield_swaps_to_inventory() {
        ...
        g.inventory.push(Item {
            kind: ItemKind::Shield, name: "Iron Shield", glyph: ')', effect: ItemEffect::BuffDefense(3), weight: 0, durability: 40,
        });
        g.equip_item(0);
    ...
    fn boots_swaps_to_inventory() {
        ...
        g.inventory.push(Item {
            kind: ItemKind::Boots, name: "Plate Boots", glyph: '{', effect: ItemEffect::BuffDefense(4), weight: 0, durability: 60,
        });
        g.equip_item(0);
    ...
    fn full_defense_stacks_all_slots() {
        ...
        g.equipped_armor = Some(Item {
            kind: ItemKind::Armor, name: "Chain Mail", glyph: '[', effect: ItemEffect::BuffDefense(4), weight: 0, durability: 40,
        });
        g.equipped_helmet = Some(Item {
            kind: ItemKind::Helmet, name: "Iron Helmet", glyph: '^', effect: ItemEffect::BuffDefense(3), weight: 0, durability: 40,
        });
        ...
        g.equipped_boots = Some(Item {
            kind: ItemKind::Boots, name: "Chain Boots", glyph: '{', effect: ItemEffect::BuffDefense(2), weight: 0, durability: 40,
        });
        g.equipped_ring = Some(Item {
            kind: ItemKind::Ring, name: "Diamond Ring", glyph: '=', effect: ItemEffect::BuffDefense(4), weight: 0, durability: 30,
        });
