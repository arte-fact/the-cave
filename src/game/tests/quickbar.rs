...
use super::test_game;
    ...
    fn potion() -> Item {
        Item { kind: ItemKind::Potion, name: "Health Potion", glyph: '!', effect: ItemEffect::Heal(10), weight: 0, durability: 0 }
    }
    fn scroll() -> Item {
        Item { kind: ItemKind::Scroll, name: "Scroll of Fire", glyph: '?', effect: ItemEffect::DamageAoe(5), weight: 0, durability: 0 }
    }
    fn food() -> Item {
