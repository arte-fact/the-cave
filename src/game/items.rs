    ...
    match tier {
        0 => {
            if roll < 26 {
                ...
                match sub % 2 {
                    0 => Item { kind: ItemKind::Scroll, name: "Scroll of Fire", glyph: '?', effect: ItemEffect::DamageAoe(8), weight: 0, durability: 0 },
                    _ => Item { kind: ItemKind::Scroll, name: "Scroll of Ice", glyph: '?', effect: ItemEffect::DamageAoe(7), weight: 0, durability: 0 },
                }
            } else if roll < 48 {
                ...
                match sub % 4 {
                    ...
                    1 => Item { kind: ItemKind::Food, name: "Waterskin", glyph: '~', effect: ItemEffect::Feed(12, FoodSideEffect::None), weight: 0, durability: 0 },
                    2 => Item { kind: ItemKind::Food, name: "Wild Berries", glyph: '%', effect: ItemEffect::Feed(15, FoodSideEffect::Heal(2)), weight: 0, durability: 0 },
                    _ => Item { kind: ItemKind::Food, name: "Cheese Wedge", glyph: '%', effect: ItemEffect::Feed(14, FoodSideEffect::Heal(1)), weight: 0, durability: 0 },
                }
            }
        }
        1 => {
            if roll < 22 {
                ...
                match sub % 2 {
                    0 => Item { kind: ItemKind::Scroll, name: "Scroll of Lightning", glyph: '?', effect: ItemEffect::DamageAoe(12), weight: 0, durability: 0 },
                    _ => Item { kind: ItemKind::Scroll, name: "Scroll of Wrath", glyph: '?', effect: ItemEffect::DamageAoe(10), weight: 0, durability: 0 },
                }
            } else if roll < 46 {
                ...
                match sub % 3 {
                    0 => Item { kind: ItemKind::Food, name: "Dried Rations", glyph: '%', effect: ItemEffect::Feed(20, FoodSideEffect::None), weight: 0, durability: 0 },
                    1 => Item { kind: ItemKind::Food, name: "Dwarven Ale", glyph: '~', effect: ItemEffect::Feed(18, FoodSideEffect::Sicken(10)), weight: 0, durability: 0 },
                    _ => Item { kind: ItemKind::Food, name: "Cheese Wedge", glyph: '%', effect: ItemEffect::Feed(14, FoodSideEffect::Heal(1)), weight: 0, durability: 0 },
                }
            }
        }
        _ => {
            if roll < 16 {
                match sub % 2 {
                    0 => Item { kind: ItemKind::Potion, name: "Superior Health Potion", glyph: '!', effect: ItemEffect::Heal(15), weight: 0, durability: 0 },
                    _ => Item { kind: ItemKind::Potion, name: "Elixir of Power", glyph: '!', effect: ItemEffect::Heal(20), weight: 0, durability: 0 },
                }
            } else if roll < 28 {
                Item { kind: ItemKind::Scroll, name: "Scroll of Storm", glyph: '?', effect: ItemEffect::DamageAoe(16), weight: 0, durability: 0 }
            } else if roll < 44 {
                ...
                match sub % 2 {
                    0 => Item { kind: ItemKind::Food, name: "Elven Waybread", glyph: '%', effect: ItemEffect::Feed(25, FoodSideEffect::Heal(5)), weight: 0, durability: 0 },
                    _ => Item { kind: ItemKind::Food, name: "Honey Mead", glyph: '~', effect: ItemEffect::Feed(18, FoodSideEffect::Energize(15)), weight: 0, durability: 0 },
                }
            }
        }
    }
...
pub(super) fn meat_drop(enemy_name: &str) -> Option<Item> {
    match enemy_name {
        ...
        "Giant Rat" => Some(Item {
            ...
            effect: ItemEffect::Feed(8, FoodSideEffect::Sicken(5)), weight: 0, durability: 0,
        }),
        // --- Small animals ---
        "Fox" => Some(Item {
            kind: ItemKind::Food, name: "Fox Meat", glyph: '%',
            effect: ItemEffect::Feed(14, FoodSideEffect::None), weight: 0, durability: 0,
        }),
        "Badger" => Some(Item {
            kind: ItemKind::Food, name: "Badger Meat", glyph: '%',
            effect: ItemEffect::Feed(12, FoodSideEffect::None), weight: 0, durability: 0,
        }),
        ...
        "Viper" => Some(Item {
            ...
            effect: ItemEffect::Feed(10, FoodSideEffect::Poison(2)), weight: 0, durability: 0,
        }),
        "Black Mamba" => Some(Item {
            kind: ItemKind::Food, name: "Snake Meat", glyph: '%',
            effect: ItemEffect::Feed(12, FoodSideEffect::Poison(3)), weight: 0, durability: 0,
        }),
        // --- Medium animals ---
        "Wolf" => Some(Item {
            kind: ItemKind::Food, name: "Wolf Meat", glyph: '%',
            effect: ItemEffect::Feed(18, FoodSideEffect::Energize(8)), weight: 0, durability: 0,
        }),
        "Coyote" => Some(Item {
            kind: ItemKind::Food, name: "Coyote Meat", glyph: '%',
            effect: ItemEffect::Feed(16, FoodSideEffect::Energize(6)), weight: 0, durability: 0,
        }),
        "Hyena" => Some(Item {
        ...
        "Lynx" => Some(Item {
            ...
            effect: ItemEffect::Feed(16, FoodSideEffect::None), weight: 0, durability: 0,
        }),
        "Cougar" => Some(Item {
            kind: ItemKind::Food, name: "Cougar Meat", glyph: '%',
            effect: ItemEffect::Feed(20, FoodSideEffect::Energize(8)), weight: 0, durability: 0,
        }),
        "Monitor Lizard" => Some(Item {
            kind: ItemKind::Food, name: "Lizard Meat", glyph: '%',
            effect: ItemEffect::Feed(18, FoodSideEffect::None), weight: 0, durability: 0,
        }),
        // --- Large animals ---
        "Boar" => Some(Item {
            kind: ItemKind::Food, name: "Boar Meat", glyph: '%',
            effect: ItemEffect::Feed(25, FoodSideEffect::Heal(3)), weight: 0, durability: 0,
        }),
        ...
        "Bear" => Some(Item {
            kind: ItemKind::Food, name: "Bear Meat", glyph: '%',
            effect: ItemEffect::Feed(30, FoodSideEffect::Heal(4)), weight: 0, durability: 0,
        }),
        "Alligator" => Some(Item {
            kind: ItemKind::Food, name: "Gator Meat", glyph: '%',
            effect: ItemEffect::Feed(28, FoodSideEffect::Heal(4)), weight: 0, durability: 0,
        }),
        "Yak" => Some(Item {
        ...
        "Water Buffalo" => Some(Item {
            ...
            effect: ItemEffect::Feed(35, FoodSideEffect::Heal(5)), weight: 0, durability: 0,
        }),
        "Male Lion" => Some(Item {
            kind: ItemKind::Food, name: "Lion Meat", glyph: '%',
            effect: ItemEffect::Feed(30, FoodSideEffect::Energize(12)), weight: 0, durability: 0,
        }),
        // --- Humanoid rations ---
            ...
            for x in 2..map.width - 2 {
                ...
                let food = if roll < 12 {
                    Item { kind: ItemKind::Food, name: "Wild Berries", glyph: '%',
                        effect: ItemEffect::Feed(14, FoodSideEffect::Heal(2)), weight: 0, durability: 0 }
                } else if roll < 22 {
                    ...
                    Item { kind: ItemKind::Food, name: "Wild Corn", glyph: '%',
                        effect: ItemEffect::Feed(14, FoodSideEffect::Energize(5)), weight: 0, durability: 0 }
                } else if roll < 64 {
                    Item { kind: ItemKind::Food, name: "Quinoa Seeds", glyph: '%',
                        effect: ItemEffect::Feed(12, FoodSideEffect::Heal(2)), weight: 0, durability: 0 }
                } else if roll < 72 {
                    Item { kind: ItemKind::Food, name: "Amaranth", glyph: '%',
                        effect: ItemEffect::Feed(10, FoodSideEffect::Heal(1)), weight: 0, durability: 0 }
                } else if roll < 80 {
                    Item { kind: ItemKind::Food, name: "Red Spinach", glyph: '%',
                        effect: ItemEffect::Feed(8, FoodSideEffect::Energize(3)), weight: 0, durability: 0 }
                } else if roll < 87 {
                    Item { kind: ItemKind::Food, name: "Bitter Vetch", glyph: '%',
                        effect: ItemEffect::Feed(8, FoodSideEffect::Poison(3)), weight: 0, durability: 0 }
                } else if roll < 93 {
